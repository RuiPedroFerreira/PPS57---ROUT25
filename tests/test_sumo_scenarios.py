...
class SumoKpiParsingTestCase(unittest.TestCase):
    ...
    def test_tripinfo_parser_reports_ingolstadt_bus_line_kpis(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            path.write_text(
                "<tripinfos>"
                '<tripinfo id="Bus_11_0001" vType="bus" line="11" depart="0" '
                'arrival="100" duration="100" routeLength="1000" waitingTime="10" '
                'timeLoss="20" waitingCount="2" />'
                '<tripinfo id="Bus_11_0002" vType="bus" line="11" depart="600" '
                'arrival="720" duration="120" routeLength="1000" waitingTime="15" '
                'timeLoss="30" waitingCount="3" />'
                '<tripinfo id="car_1" vType="car" depart="0" arrival="80" '
                'duration="80" routeLength="900" waitingTime="5" timeLoss="8" '
                'waitingCount="1" />'
                "</tripinfos>",
                encoding="utf-8",
            )
